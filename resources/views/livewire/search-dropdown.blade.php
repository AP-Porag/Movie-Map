<div class="relative" x-data="{ isOpen:true}" @click.away="isOpen=false">
    <input
        ...
        class="bg-gray-800 rounded-full w-64 pl-8 px-4 py-1 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent"
        placeholder="Search"
        x-ref="search"
        @keydown.window="
            ...
            <ul>
                @foreach($searchResults as $result)
                    <li class="border-b border-gray-700">
                        <a
                            href="{{route('single-movie',$result['id'])}}"
