        ...
        <div class="movie-info border-b border-gray-800">
            <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                ...
                <div class="md:ml-24">
                    ...
                    <h6 class="text-1xl mt-4 md:mt-0 font-semibold"><span>Budget : </span><span class="text-yellow-500">{{$movie['budget']}}</span> | <span>Revenue : </span><span class="text-yellow-500">{{$movie['revenue']}}</span></h6>
